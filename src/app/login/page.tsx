...
export default function LoginPage() {
    ...
    return (
        <div className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-br from-slate-950 via-indigo-950 to-slate-900 px-4 text-center">
            ...
            <div className="fixed inset-0 pointer-events-none bg-[radial-gradient(circle_at_50%_0%,rgba(120,119,198,0.15),transparent_50%)]" />

            <div className="relative z-10 w-full max-w-[350px] space-y-8">
